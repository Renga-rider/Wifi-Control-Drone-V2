...
#define BOARD_FIRMWARE_TYPE           "V2"                // Unique identifier of a firmware
#define BOARD_NAME                    "Drone Controller"        // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "Renga_rider"        // Name of your company. Should match App Export request info.
#define BOARD_TEMPLATE_ID             "TMPL0000"            // ID of the Tile Template. Can be found in Tile Template Settings

#define PRODUCT_WIFI_SSID             "Renga_Rider"         // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "https://bit.ly/2OVPERM"      // Config page will be available in a browser at 'http://our-product.cc/'
