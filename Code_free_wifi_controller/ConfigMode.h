...
<body>
<h1><center>Renga_Rider</center></h1>
<h2 style="color:white;"><center>make it simple</center></h2>
<div class="centered">
  <form method="get" action="config">
    <table>
    <tr><td><label for="ssid">WiFi SSID:</label></td>  <td><input type="text" name="ssid" placeholder="Wifi name"length=64 required="required"></td></tr>
    <tr><td><label for="pass">Password:</label></td>   <td><input type="text" name="pass" placeholder="wifi password" length=64></td></tr>
    <tr><td><label for="blynk">Auth token:</label></td><td><input type="text" name="blynk" placeholder="copy from blynk" maxlength="32" required="required"></td></tr>
    <tr><td><label for="host">Host:</label></td>       <td><input type="text" name="host" placeholder="not neccessary" length=64></td></tr>
